...
const CACHE_VERSION = "goalbuddy-b89321d642df";
// GEN:VERSION-END
...
const SHELL = [
  ...
  "./js/sync-adapter.js",
  "./js/sync.js",
  "./js/ui/confirmsheet.js",
  "./js/ui/dashboard.js",
  "./js/ui/demo.js",
  "./js/ui/editor.js",
  "./js/ui/exercisesheet.js",
  "./js/ui/format.js",
  "./js/ui/goals.js",
  "./js/ui/habitdetail.js",
  "./js/ui/habitsheet.js",
  "./js/ui/invitesheet.js",
  "./js/ui/levelmark.js",
  "./js/ui/levelsheet.js",
  "./js/ui/logsheet.js",
  "./js/ui/onboard.js",
  "./js/ui/problem.js",
  "./js/ui/programsheet.js",
  "./js/ui/pulltorefresh.js",
  "./js/ui/schedulesheet.js",
  "./js/ui/scoringsheet.js",
  "./js/ui/seasonsheet.js",
  "./js/ui/seasonssheet.js",
  "./js/ui/sheet.js",
  "./js/ui/travelsheet.js",
  "./js/ui/weeksheet.js",
  "./js/ui/workoutdraft.js",
  "./js/ui/workouthistory.js",
  "./js/ui/workoutsheet.js",
  "./js/update.js",
  "./js/vitals.js",
  "./js/workout.js",
  // GEN:SHELL-END
